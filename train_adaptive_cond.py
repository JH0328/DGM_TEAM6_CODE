...
from models.diffusion import DDPMv2, SuperResModel, UNetModel
...
@hydra.main(config_path="./configs/dataset/cifar10/", config_name="train_ej.yaml")
def train(config):
    ...
    ddpm_wrapper = DDPMWrapper(
        ...
        use_adaptive_conditioning=config.training.use_adaptive_conditioning, 
    )
