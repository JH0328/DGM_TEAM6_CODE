...
from models.diffusion import DDPMv2, SuperResModel
from models.diffusion.EJ_wrapper import DDPMWrapper
from models.diffusion.EJ_ddpm import DDPM
...
os.makedirs('./results_ddpm_ej', exist_ok=True)
# os.makedirs('./results_vae', exist_ok=True)

@hydra.main(config_path="./configs/dataset/cifar10", config_name="test_ej.yaml")
...
def sample_cond(config):
    ...
    ddpm_wrapper = DDPMWrapper.load_from_checkpoint(
        ...
        use_adaptive_conditioning=config_ddpm.evaluation.use_adaptive_conditioning,  #
