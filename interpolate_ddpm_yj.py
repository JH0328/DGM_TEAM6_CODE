...
import copy
import os
# /home/emin38/main/outputs/2024-12-03/07-17-24/results/checkpoints/
import hydra
import torch
...
@hydra.main(config_path="./configs/dataset/cifar10", config_name="test.yaml")
def interpolate_ddpm(config):
    ...
    ddpm_wrapper = yj_DDPMWrapper.load_from_checkpoint(
