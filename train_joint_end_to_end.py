...
from models.diffusion import DDPM, DDPMv2, SuperResModel, UNetModel
from models.diffusion.yj_wrapper import yj_DDPMWrapper
...
@hydra.main(config_path="./configs/dataset/cifar10", config_name="train_joint_end_to_end.yaml")
def train(config):
...
# Setup callbacks
    ...
    chkpt_callback = ModelCheckpoint(
        ...
        filename=f"yj_ddpmv2-{config.training.chkpt_prefix}" + "-{epoch:02d}-{loss:.4f}",
