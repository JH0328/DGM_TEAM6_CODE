...
def args_parser():
    ...
    parser.add_argument('--zdim', type=int, default=512, help='z_dim')
    parser.add_argument('--chkpt', type=str, default='./pretrained/vae_cifar10_loss=0.00.ckpt', help='checkpoint path')
    parser.add_argument('--num_samples', type=int, default=-1, help='# of samples')
    parser.add_argument('--gpu', type=str, default='0', help='GPU ID')
    parser.add_argument('--results', type=str, default='./results', help='GPU ID')
...
if __name__ == "__main__":
    ...
    sample(z_dim=z_dim, chkpt_path=chkpt_path, num_samples=num_samples, device=device, save_path=save_path)
